        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              ...
              <a href="<?php echo base_url();?>admin/add_category" style="margin-left:10px;" class="btn btn-primary "> <span class="glyphicon glyphicon-plus"></span> add </a>
            </ul>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            ...
            <div class="table-responsive">
               <table
                 ...
                 id='student_collect_fees_data'
       					 data-toggle="table"
                 data-sortable="true"
       					 data-url="<?php echo base_url();?>admin/get_category_data"
