            ...
            <form class="" action="#" method="post" novalidate enctype="multipart/form-data">
              ...
              <div class="field item form-group">
                <label class="col-form-label col-md-3 col-sm-3  label-align"> Product Name<span
                    class="required">*</span></label>
                <div class="col-md-6 col-sm-6">
                  <input class="form-control" name="name" placeholder="Name" maxlength="30" minlength="3" data-validate-length-range="6" data-validate-words="1" required="required" value="<?php echo $users->name; ?>"/>
                </div>
              </div>
                    ...
                    <select class="form-control" required="required" name="sub_category">
                        <?php if(isset($sub_category) and $sub_category != NULL){
                          foreach ($sub_category as $row){
                            if($row->id == $users->subcategory_id){
                              echo '<option value="'.$row->id.'" selected>'.$row->name.'</option>';
                            }else{
                              echo '<option value="'.$row->id.'">'.$row->name.'</option>';
                            }
              ...
              <div class="field item form-group">
                <label class="col-form-label col-md-3 col-sm-3  label-align"> Price <span
                    class="required">*</span></label>
                <div class="col-md-6 col-sm-6">
                  <input type="number" class="form-control" name="price" required="required" value="<?php echo $users->price; ?>"/>
                </div>
              </div>
              ...
              <div class="field item form-group">
                <label class="col-form-label col-md-3 col-sm-3  label-align"> In Stock <span
                    class="required">*</span></label>
                <div class="col-md-6 col-sm-6">
                  <input type="number" class="form-control" name="in_stock" placeholder="20" required="required" value="<?php echo $users->in_stock; ?>" />
                </div>
              </div>
