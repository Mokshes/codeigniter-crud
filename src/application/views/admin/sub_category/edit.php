            ...
            <form class="" action="#" method="post" novalidate enctype="multipart/form-data">
                  ...
                  <select class="form-control" required="required" name="parent_id">
                    <?php if(isset($category) and $category != NULL){
                      foreach ($category as $row){
                        ...
                        if($row->id == $sub_category->parent_id){
              ...
              <div class="field item form-group">
                <label class="col-form-label col-md-3 col-sm-3  label-align"> Category Name<span
                    class="required">*</span></label>
                <div class="col-md-6 col-sm-6">
                  <input class="form-control" name="name" placeholder="Name" maxlength="30" minlength="3" data-validate-length-range="6" data-validate-words="1" required="required" value="<?php echo $sub_category->name; ?>"/>
                </div>
              </div>
